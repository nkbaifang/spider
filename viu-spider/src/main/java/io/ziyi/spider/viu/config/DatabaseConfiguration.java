package io.ziyi.spider.viu.config;
...
@Configuration
@EntityScan("io.ziyi.spider.viu.model")
...
public class DatabaseConfiguration extends BaseComponent {
    ...
    public DataSource createDataSource(@Autowired HikariConfig config) {
        String jdbcUrl = ConfigTools3.getString("spider.viu.database.url");
        String username = ConfigTools3.getString("spider.viu.database.username");
        String password = ConfigTools3.getString("spider.viu.database.password");
    ...
    public FactoryBean<SessionFactory> createSessionFactory(@Autowired DataSource dataSource) {
        ...
        bean.setPackagesToScan("io.ziyi.spider.viu.model");
    ...
    public PlatformTransactionManager createTransactionManager(@Autowired SessionFactory sessionFactory) {
        int txTimeout = ConfigTools3.getInt("spider.viu.database.tx-timeout-seconds", 10);
    ...
    private Properties getHibernateProperties() {
        ...
        props.put("hibernate.dialect", ConfigTools3.getString("spider.viu.database.hibernate.dialect", "org.hibernate.dialect.MySQL57Dialect"));
        props.put("hibernate.show_sql", ConfigTools3.getBoolean("spider.viu.database.show-sql", false));
